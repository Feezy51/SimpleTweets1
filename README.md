...
*SimmpleTweets* is an android app that allows a user to view his Twitter timeline. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
I dropped my Computer and it broke, so my Tech fellow helped me with twitter part 1
